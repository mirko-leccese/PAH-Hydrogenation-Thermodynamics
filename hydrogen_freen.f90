...
! This subroutine computes the Gibbs Free Energy of H2
...
!
! Out:
!   lambdaH2 (real): thermal wavelength of atomic H2
!   ZvH2, ZrH2, ZiH2 (real): vibrational, rotational and internal partition function of H2
!   GH2 (real): Gibbs Free Energy of H2
