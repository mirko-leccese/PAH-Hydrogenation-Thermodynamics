...
!Thermodynamic paramters of H2 from Nist Webbook
...
!REAL(8), PARAMETER :: B=159.29239791717430d0           !Rotational constants adjusted to ensure continuity with Shomate equation at 298.15K
							!This is the value I used in the original code
REAL(8), PARAMETER :: B=60.9d+2				!The true rotational constants of H2 in m^-1
!REAL(8), PARAMETER :: B=159.29239792d+2		!Rotational constats adjucted to ensure continuity with Shomate, m^-1
